---
title: "Figure 04. Absolute effect size of susceptibility associated variants by frequency"
execute:
  warning: false
  message: false
---
...
pub_figure <- tox.effect.bubble +
  theme(
    ...
    legend.title = element_text(size = 9, color = "black", face = "bold", family = "Helvetica"),
    legend.text = element_text(size = 8, color = "black", family = "Helvetica"),
    axis.text = element_text(color = "black", family = "Helvetica"),
    axis.title = element_text(color = "black", face = "bold", family = "Helvetica")
  )
