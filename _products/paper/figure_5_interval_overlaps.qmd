...
qtl_overlaps <- ggplot() +
  ...
  theme(
    strip.text.y.right = element_text(angle = 0, family = "Helvetica", size = 8, face = "bold", lineheight = 0.9),
    strip.text.x = element_text(family = "Helvetica", size = 10, face = "bold"),
    axis.text.y = element_text(family = "Helvetica", size = 10, face = "bold", color = "black"),
    axis.title.y = element_blank(),
    axis.title.x = element_text(family = "Helvetica", size = 10, face = "bold"),
    axis.text.x = element_text(family = "Helvetica", size = 10, color = "black"),
