---
title: "Format candidate gene data with rankings and format gene names"
---

```{r}
#| label: candidate-genes-org-setup
#| include: false
...
candidate_flex_table_pre <- candidate_pre_table %>%
  ...
  dplyr::rename(
    ...
    `Reference Allele` = effect_allele,
    `Alternative Allele` = other_allele,
    Log10p = max_log10p,
    `LD (r2)` = max_marker_ld,
    MAF = max_marker_maf,
...
```{r}
#| label: candidate-genes-table-save
