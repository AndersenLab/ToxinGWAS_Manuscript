...
pheno_path <- "data/raw/phenotypes/pheno.df.rda"
```
...
# load phenotype data
load("data/processed/pheno.df.rda")
...
data.table::fwrite(
  hvr_df,
  glue::glue("data/processed/HDR_overlap/{today}_hvr_gwas_strains.tsv"),
  sep = "\t",
  quote = FALSE
)
...
data.table::fwrite(
  hvr_df_collapsed,
  glue::glue("data/processed/HDR_overlap/{today}_hvr_gwas_strains_collapsed.tsv"),
  sep = "\t",
  quote = FALSE
)
