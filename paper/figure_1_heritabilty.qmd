---
title: "Figure 01. Heritability of toxicant susceptibilities"
execute:
  warning: false
  message: false
---
...
load(file.path("data/processed/heritability/h2.list.mean.rda"))

# load the H2 data from boots
load(file.path("data/processed/heritability/H2.parametric.boot.list.10000.rda"))
