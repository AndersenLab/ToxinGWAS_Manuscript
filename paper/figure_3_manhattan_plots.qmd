---
title: "Figure 03. Representative Manhattan plots showing 19 of 40 susceptibility-associated regions identified with GWAS"
execute:
  warning: false
  message: false
---
...
manhattan_plots <- ggplot(d.all2) +
  ...
  theme(
    ...
    strip.text.y = element_text(family = "Helvetica", size = 8, face = "bold")
  ) +
  ggh4x::facet_grid2(
