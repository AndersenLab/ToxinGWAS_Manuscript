...
total_independent_tests <- read.table(file.path(project_root, "data/processed/20231116_Analysis_NemaScan/Genotype_Matrix/total_independent_tests.txt"), quote = "\"", comment.char = "", stringsAsFactors = FALSE)
...
```{r}
saveRDS(manhattan_plots, file = "_shared/manhattan_plots.rds")
```
