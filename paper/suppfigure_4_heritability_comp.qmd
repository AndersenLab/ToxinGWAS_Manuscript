---
title: "Comparison of the heritability estimates to Widmayer 2022"
format: html
---
...
```{r}
#| label: fig-heritability_comp
#| fig-width: 7.5
#| fig-height: 3
#| fig-cap: Regression of heritability estimates for the 195 strains in the GWAS mapping panel against the eight strains from Widmayer et al. 2022.
#| fig-alt: (A) Broad-sense heritability estimates. (B) Narrow-sense heritability estimates. Each point represents the heritability estimate for a particular toxicant condition. In each panel, the regression equation, Pearson’s correlation coefficient (r), and the associated p-value (p) are shown in the upper left corner.
h_comp_supplement
```
