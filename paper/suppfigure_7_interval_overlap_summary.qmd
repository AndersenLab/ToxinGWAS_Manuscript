---
title: "Figure S07. Physical overlaps of susceptibility-associated intervals across toxicants"
---
...
annotation_df <- data.frame(
  ...
  y = c(2.75, 3.25),
  label = c(
    paste0("italic(p) == ", format(p_value, digits = 3)),
    paste0("R^2 == ", format(summary(lm_model)$r.squared, digits = 3))
  )
)
