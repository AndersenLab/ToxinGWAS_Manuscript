...
combined_heatmaps <- grid.arrange(
  ...
  top = textGrob("", gp = gpar(fontsize = 14, fontfamily = "Helvetica")),  # Empty title to create space
  left = textGrob("", gp = gpar(fontsize = 14, fontfamily = "Helvetica")),  # Empty left margin for labels
