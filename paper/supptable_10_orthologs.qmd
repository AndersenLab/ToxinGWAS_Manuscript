---
title: "Supplementary Table 10: Human Orthologs of candidate genes"
---
...
# Inputs
`cg`: candidate genes table generated in `paper/supptable_7_candidate_genes.qmd`

```{r}
---
title: "Add human orthologs to the candidate genes"
---
...
# Inputs
`candidate_out_name` - path to the candidate file output by `analysis/call_candidate_genes.qmd` and then modified in `analysis/candidate_gene_effects.qmd`
...
orthos <- readxl::read_xlsx("data/raw/ortholist_master.xlsx")
...
```{r}
output_fn <- "data/processed/interval_genes/candidate_genes/inbred_candidate_genes_with_human_orthologs.tsv.gz"
